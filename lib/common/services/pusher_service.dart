...
class PusherService {
  ...
  String APP_ID = "1846322";
  String API_KEY = "f08d7ba8e5827138a68d";
  String SECRET = "fb01ab2c759dda140b76";
  String API_CLUSTER = "eu";

  Future<void> initPusher(onEvent, {channelName = "room.", roomId}) async {
